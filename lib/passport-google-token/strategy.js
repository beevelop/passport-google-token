...
GoogleTokenStrategy.prototype.authenticate = function (req, options) {
  ...
  var accessToken = _.get(req, 'body.access_token') || _.get(req, 'query.access_token') || _.get(req, 'headers.access_token')
  var refreshToken = _.get(req, 'body.refresh_token') || _.get(req, 'query.refresh_token') || _.get(req, 'headers.refresh_token')
